...
LOG_FILE="${LOG_ROOT}/${MODEL_SHORT}-transmla-${CAL_DATASET}-rank${RANK}.log"
SAVE_PATH="${SAVE_ROOT}/${MODEL_SHORT}-mla-transmla-${CAL_DATASET}-rank${RANK}"
...
echo "[DONE] TransMLA log: ${LOG_FILE}"
