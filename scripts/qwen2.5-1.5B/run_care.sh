...
LOG_FILE="${LOG_ROOT}/${MODEL_SHORT}-care-${CAL_DATASET}-rank${RANK}.log"
SAVE_PATH="${SAVE_ROOT}/${MODEL_SHORT}-mla-care-${CAL_DATASET}-rank${RANK}"
