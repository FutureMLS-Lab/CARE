#!/bin/bash
# Parallel zero-shot runner for LLaMA-3.1-8B-Instruct
# Usage: bash scripts/zeroshot/run_parallel_llama3.1_8B.sh
...
MODEL=${MODEL_PATH:-meta-llama/Llama-3.1-8B-Instruct}
