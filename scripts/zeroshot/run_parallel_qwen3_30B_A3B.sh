#!/bin/bash
# Parallel zero-shot runner for Qwen3-30B-A3B.
# Usage: bash scripts/zeroshot/run_parallel_qwen3_30B_A3B.sh
# Override with env vars: PYTHON, MODEL_PATH, RANKS, GPU_LIST,
# GPU_FREE_MEM_THRESHOLD, GPU_MAX_TASKS_PER_GPU, GPU_REUSE_COOLDOWN_SECONDS,
# CAL_DATASETS, PPL_DATASET, METHODS, OUTPUT_ROOT
...
GPU_FREE_MEM_THRESHOLD="${GPU_FREE_MEM_THRESHOLD:-70000}"
GPU_MAX_TASKS_PER_GPU="${GPU_MAX_TASKS_PER_GPU:-1}"
GPU_REUSE_COOLDOWN_SECONDS="${GPU_REUSE_COOLDOWN_SECONDS:-90}"
